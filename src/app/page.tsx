    ...
    <SectionShell id="hero" dark>
      <div style={{ paddingTop: 40, paddingBottom: 20 }}>
        ...
        <p style={{
          ...
          How campaign design — not just content volume — appears to shape channel growth.
        </p>
        <div style={{
...
function About() {
  return (
    <SectionShell id="about">
      ...
      <SectionTitle>About This Analysis</SectionTitle>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20, marginBottom: 32 }}>
        <Card>
          <div className="eyebrow" style={{ color: ELECTRIC, marginBottom: 12 }}>Dataset</div>
          <BulletList color={ELECTRIC} items={[
            '138 channels analysed across Virgin and Market',
            '3,554 individual videos reviewed',
            '82 Virgin-managed channels',
            '56 comparable market benchmark channels',
          ]} />
        </Card>
        <Card>
          <div className="eyebrow" style={{ color: MINT, marginBottom: 12 }}>Methodology</div>
          <BulletList color={MINT} items={[
            'Channel health benchmarking (Growing, Weak Conversion, Underfed, Cold)',
            'Follow-up window analysis (7–30 days post-hero)',
            'Content type and diversity scoring',
            'Manual validation of 7 active campaigns',
          ]} />
        </Card>
      </div>
      <div style={{
        ...
        <strong style={{ color: INK }}>Important:</strong> These are observed behaviours, not YouTube rules.
        We are identifying patterns and opportunities, not proving causation. All findings are based on our
        dataset and should be treated as starting points for discussion.
      </div>
    </SectionShell>
  );
}
...
function StoryInNumbers() {
  return (
    <SectionShell id="numbers" dark>
      ...
      <Subtitle color="rgba(255,255,255,0.5)">Follow-up behaviour observed across 138 channels</Subtitle>
      ...
      <div style={{
        marginTop: 24, fontSize: '0.78rem', color: 'rgba(255,255,255,0.3)',
        fontStyle: 'italic',
      }}>
        The remaining 9% have limited longform follow-up (one content type only).
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.85)', lineHeight: 1.6, margin: 0, fontWeight: 600 }}>
            The strongest channels weren't necessarily making more content. They were creating more opportunities for audiences to return.
          </p>
        </div>
        <div style={{
          background: 'rgba(255,255,255,0.04)',
      ...
      <div style={{
        ...
        <div className="eyebrow" style={{ color: ELECTRIC, marginBottom: 8 }}>Aligns With YouTube Guidance</div>
        <p style={{ fontSize: '0.88rem', color: 'rgba(255,255,255,0.6)', lineHeight: 1.6, margin: 0 }}>
          YouTube for Artists recommends using multiple content formats around a release, including
          Shorts, music videos, lyric videos, BTS content, and live content. Our benchmark shows that
          campaigns fully embracing this approach remain a minority — only 15% run a multi-format rollout.
        </p>
      </div>
    </SectionShell>
  );
...
function ToveLo() {
  return (
    <SectionShell id="tove-lo">
      ...
      <Subtitle>
        One of the strongest campaign structures we observed. Not more content. Better sequencing.
      </Subtitle>
      ...
      <DarkCard accent={MINT}>
        ...
        <p style={{ fontSize: '0.92rem', lineHeight: 1.6, color: 'rgba(255,255,255,0.8)', margin: 0 }}>
          Not more content. Better sequencing. The strongest campaign we observed used multiple formats
          staggered across weeks — each asset served a different purpose: BTS for depth, Lyric for search, Remix for reach.
        </p>
      </DarkCard>
    </SectionShell>
  );
...
function StrategyFramework() {
  return (
    <SectionShell id="framework">
      ...
      <SectionTitle>Different Artists Need Different Strategies</SectionTitle>
      <Subtitle>Four campaign approaches observed in our dataset.</Subtitle>
...
function CaseStudies() {
  ...
  return (
    <SectionShell id="case-studies">
      ...
      <SectionTitle>Campaign Case Studies</SectionTitle>
      <Subtitle>
        Each artist was chosen because the data shows something specific worth learning from.
      </Subtitle>
...
function Benchmarks() {
  return (
    <SectionShell id="benchmarks">
      ...
      <SectionTitle>Where we stand. Where we can improve.</SectionTitle>
      <Subtitle>Based on 138 channels: 82 Virgin, 56 Market.</Subtitle>
      ...
      <div style={{
        ...
        <strong style={{ color: INK }}>Two observed opportunities:</strong> Live sessions create an additional
        audience return point — our biggest gap at 15 points. Lyric videos create another entry point
        into the campaign — 10 points behind market. The remaining differences are modest and within margin of error.
        <span style={{ color: SIGNAL, fontWeight: 600 }}> ●</span> = actionable gap we would test.
      </div>
    </SectionShell>
  );
}
  ...
  return (
    <SectionShell id="diversity">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20, marginBottom: 32 }}>
        ...
        <DarkCard>
          ...
          <div style={{ fontSize: '1.15rem', fontWeight: 700, color: '#fff', marginBottom: 12 }}>
            content types places a channel in the top 10% of content diversity across our benchmark
          </div>
          <div style={{
          ...
          <div style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.4)', lineHeight: 1.5 }}>
            YouTube recommends using multiple content formats across a campaign.
            Our benchmark shows relatively few channels fully use that toolkit.
          </div>
        </DarkCard>
      ...
      <div style={{
        ...
        <strong style={{ color: INK }}>The nuance:</strong> Content diversity creates opportunity. Campaign
        design determines whether that opportunity is realised. Weak Conversion channels made MORE types
        than Growing channels — diversity alone did not convert viewers. What appeared to matter was
        whether content was sequenced and timed around releases.
      </div>
    </SectionShell>
  );
}
...
function ConfidenceLevels() {
  return (
    <SectionShell id="confidence">
      ...
      <SectionTitle>Not everything carries equal weight.</SectionTitle>
      <Subtitle>
        We grade our findings by how consistently they appeared across the dataset.
        Some patterns showed up repeatedly. Others need more testing.
      </Subtitle>
...
function WhatTheDataChanged() {
  return (
    <SectionShell id="corrections">
      ...
      <SectionTitle>What The Data Changed Our Mind About</SectionTitle>
      <Subtitle>The findings that revised our initial assumptions.</Subtitle>
...
function CampaignFramework() {
  return (
    <SectionShell id="playbook">
      ...
      <SectionTitle>Multi-Format Rollout Playbook</SectionTitle>
      <Subtitle>
        Based on observed campaign behaviour, not speculation.
        We are still testing optimal spacing.
      </Subtitle>
      ...
      <div style={{
        ...
        We are still testing optimal spacing. This timeline is based on observed campaign patterns
        and YouTube partner guidance. Treat these as starting points, not rules.
      </div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '1rem', fontWeight: 700, color: INK, lineHeight: 1.5, margin: '0 0 8px' }}>
          The goal is not four assets. The goal is four audience return moments.
        </p>
        <p style={{ fontSize: '0.88rem', color: WARM, lineHeight: 1.6, margin: 0 }}>
          This is a campaign design framework, not a content checklist.
          Each window represents a reason for audiences to come back — not just a thing to upload.
        </p>
      </div>
    </SectionShell>
  );
...
function SuccessSection() {
  return (
    <SectionShell id="success">
      ...
      <Subtitle>
        You don't need every box. But the strongest campaigns we observed usually ticked most of them.
      </Subtitle>
    ...
    <SectionShell id="takeaways" dark>
      ...
      <div style={{
        ...
        <div className="headline" style={{
          ...
          It's designing campaigns that create more opportunities for audiences to return.
        </div>
        <div style={{
          fontSize: '0.95rem', color: 'rgba(255,255,255,0.4)',
          maxWidth: 600, lineHeight: 1.5,
        }}>
          This is the clearest pattern we observed across 138 channels and 3,554 videos.
        </div>
        <div style={{
